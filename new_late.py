...
def display_images(images, save_path, names):
    try:
        ...
        for steps, image in enumerate(images):
            image.save(f"{save_path}/{filename}_{names}_step{steps}.png")
...
save_path = "latent_pytorch/output"
...
display_images(images, save_path, 1)
...
# Display of saved generated images.
display_images(images, save_path, 2)
################################################################################################################################################################################################
